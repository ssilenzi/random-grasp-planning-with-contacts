function [I,check]=intersect_plane_and_line(n,V0,P0,P1)
% plane_line_intersect computes the intersection of a plane and a segment
% (or a straight line)
% Inputs: 
...
% P0=[-5 1 -1]
% P1=[1 2 3]   
% [I,check]=intersectPlaneAndLine([1 1 1],[1 1 -5],[-5 1 -1],[1 2 3]);
...
if (sI < 0 || sI > 1)
    check = 3;
    % The intersection point lies outside the segment, 
