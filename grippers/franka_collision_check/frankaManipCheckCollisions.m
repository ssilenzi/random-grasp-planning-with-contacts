function [isInCollision, selfCollisionPairIdx, worldCollisionPairIdx] = ...
    frankaManipCheckCollisions(tree, bodyCollisionArray, ...
    worldCollisionArray, config, isExhaustiveChecking)
% This function is for internal use only and may be removed in a future release

% frankaManipCheckSelfCollisions Check for collisions between robot bodies
