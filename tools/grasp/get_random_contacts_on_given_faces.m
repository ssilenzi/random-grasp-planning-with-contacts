function [Cp_glob,Cn_glob] = ...
    ...
    given_faces,partial_faces,sym_conts,same_conts)
...
if sym_conts && same_conts
    warning('I am going for same contacts as you told me they are both symmetric and same!!!');
end
...
if same_conts
    p(2,:) = p(1,:) + 0.013 * (ones(1,3) - rand(1,3)); % second pos = almost first pos
    n(2,:) = n(1,:); % second normal = first normal
end
