...
% mu_hand_val = 0.7; mu_env_val = 0.1; % Best as of now (except heavy cluttered)
mu_hand_val = 0.7; mu_env_val = 0.2;
...
% Forces of hand zero at the beginning?
% fp(1:6) = zeros(6,1);
% Trying to remove the moment part from we
% we = we(1:3,:);
% G = G(1:3,:);
...
f_max_vect = 2*ones(1,num_cp); f_max_vect(1:2) = 5*ones(1,2);
Delta = 0.00005;
