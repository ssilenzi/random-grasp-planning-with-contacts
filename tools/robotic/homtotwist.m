...
% HOMTOTWIST  finds a twist and a theta to create the homogeneous 
% transform T 
%
%    [XI THETA] = HOMTOTWIST(T)
%
% Note: There are multiple possible combinations of xi and theta that 
% satisfy
