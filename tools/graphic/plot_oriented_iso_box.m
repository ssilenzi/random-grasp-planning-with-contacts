function handle = plot_oriented_iso_box(X, Y, T, RGBColor)
...
handle(1)  = line(lines{1}(:,3),  lines{1}(:,1),  lines{1}(:,2));
handle(2)  = line(lines{2}(:,3),  lines{2}(:,1),  lines{2}(:,2));
handle(3)  = line(lines{3}(:,3),  lines{3}(:,1),  lines{3}(:,2));
handle(4)  = line(lines{4}(:,3),  lines{4}(:,1),  lines{4}(:,2));
handle(5)  = line(lines{5}(:,3),  lines{5}(:,1),  lines{5}(:,2));
handle(6)  = line(lines{6}(:,3),  lines{6}(:,1),  lines{6}(:,2));
handle(7)  = line(lines{7}(:,3),  lines{7}(:,1),  lines{7}(:,2));
handle(8)  = line(lines{8}(:,3),  lines{8}(:,1),  lines{8}(:,2));
handle(9)  = line(lines{9}(:,3),  lines{9}(:,1),  lines{9}(:,2));
handle(10) = line(lines{10}(:,3), lines{10}(:,1), lines{10}(:,2));
handle(11) = line(lines{11}(:,3), lines{11}(:,1), lines{11}(:,2));
handle(12) = line(lines{12}(:,3), lines{12}(:,1), lines{12}(:,2));
set(handle, 'Color', RGBColor)
